...
export class jqBranch {
    ...
    private branchChildrenList: number[];
    ...
    constructor(_jqLabel: string) {
        ...
        this.branchChildrenList = new Array<number>();
    ...
    getChildrenList(): jqBranch[]{
      
        var _lengthChildren = this.getChildrenLength();

        var _tmpBranchList = new Array<jqBranch>();
