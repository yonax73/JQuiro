define(["require", "exports", './com/jquiro/progress_bar/jqprogressbar', './com/jquiro/tree/JQTree', './com/jquiro/base_component/JQElement'], function(require, exports, pr, tr, el) {
    ...
    skillsBranch.getBranch().addEvent(el.jqEvent.CLICK, function (e) {
    ...
    var descFreeLanceLeaf = new tr.jqLeaf('Cuando era un aficionado tuve la suerte de trabajar para un profesor,haciendo blogs y luego un proyecto de una p�gina de cursos de ingles, lo que me dio experiencia en java, html, javascript, mysql, css.');
    ...
    var descSoftColLeaf = new tr.jqLeaf('Empresa start-up donde realice mis practicas universitarias por 6 meses, luego trabaje 6 meses m�s como prestador de servicios; funciones como programador con Java, HTML, JavaScript, Php, MySql, Css.');
